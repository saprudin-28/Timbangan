...
#define PIN_DMD_A         3    // D6
#define PIN_DMD_B         4    // D7
#define PIN_DMD_CLK       7   // D13_SCK  is SPI Clock if SPI is used
#define PIN_DMD_SCLK      14    // D8
#define PIN_DMD_R_DATA    5   // D11_MOSI is SPI Master Out if SPI is used
#else
